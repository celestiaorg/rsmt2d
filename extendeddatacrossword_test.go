...
func TestRepairExtendedDataSquare(t *testing.T) {
	for codecName, codec := range codecs {
		t.Run(codecName, func(t *testing.T) {
			...
			t.Run("CorruptedEDS", func(t *testing.T) {
				...
				t.Run("BadRowInOriginalData", func(t *testing.T) {
					corrupted, err = original.deepCopy(codec)
					if err != nil {
						t.Fatalf("unexpected err while copying original data: %v, codec: :%s", err, codecName)
					}
				...
				t.Run("BadRowInExtendedData", func(t *testing.T) {
					corrupted, err = original.deepCopy(codec)
					if err != nil {
						t.Fatalf("unexpected err while copying original data: %v, codec: :%s", err, codecName)
					}
				...
				t.Run("BadColumnInOriginalData", func(t *testing.T) {
					corrupted, err = original.deepCopy(codec)
					if err != nil {
						t.Fatalf("unexpected err while copying original data: %v, codec: :%s", err, codecName)
					}
				...
				t.Run("BadColumnInExtendedData", func(t *testing.T) {
					corrupted, err = original.deepCopy(codec)
					if err != nil {
						t.Fatalf("unexpected err while copying original data: %v, codec: :%s", err, codecName)
					}
